...
public:
    ...
    PositionNames() {
        ...
        posNames.emplace_back("iнженер");
        posNames.emplace_back("cтарший iнженер");
        posNames.emplace_back("молодший науковий спiвробiтник");
        posNames.emplace_back("cтарший науковий спiвробiтник");
